...
<div class="filter__table">
    <div class="nav nav-pills" id="pills-tab" role="tablist">
        <button class="btn filter__btn me-0 me-md-3 shadow-none active nav-link active" id="pills-standar-penelitian" data-bs-toggle="pill" data-bs-target="#pills-table-standar-penelitian" type="button" role="tab" aria-controls="pills-table-standar-penelitian" aria-selected="true">
            Penelitian
        </button>
        <button class="btn filter__btn shadow-none nav-link" id="pills-standar-pm" data-bs-toggle="pill" data-bs-target="#pills-table-standar-pm" type="button" role="tab" aria-controls="pills-table-standar-pm" aria-selected="false">
    ...
    <div class="tab-pane fade show active" id="pills-table-standar-penelitian" role="tabpanel">
        <div class="sipmpp__table">
            ...
            <div class="table-responsive">
                <table class="table table__standar__content sipmpp__table-content table-hover" id="standar-penelitian">
                    ...
                    <tbody>
                        <?php foreach ($standar as $standar) : ?>
                            <tr>
                                ...
                                <td>
                                    <a data-bs-placement="top" title="lihat" href="/admin/viewIndikator/<?= $standar['standar_id'] . '/' . $standar['kategori_id']; ?>" class="edit__data__induk__icon me-5"><i class="fa-solid fa-eye"></i></a>
                                    <a data-bs-placement="top" title="Edit" href="/admin/editstandar/<?= $standar['standar_id'] . '/' . $standar['kategori_id']; ?>" class="edit__data__induk__icon me-5"><i class="fa-solid fa-pen-to-square"></i></a>
