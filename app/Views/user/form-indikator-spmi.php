...
<html lang="en">
  <head>
    ...
    <title>Form Indikator SPMI - S1 Informatika | SIPMPP UNDIP</title>
    ...
    <link
      rel="stylesheet"
      href="https://use.fontawesome.com/releases/v6.1.0/css/solid.css"
      integrity="sha384-ltWlpN+Dl8XfKEnC9oW+dDRF8Z7jsYkxQ/WMRoJ2VHH5G2nQZ4if2NWwmV0ybzZ7"
      crossorigin="anonymous"
    />
    <link
      rel="stylesheet"
      href="https://use.fontawesome.com/releases/v6.1.0/css/fontawesome.css"
      integrity="sha384-RLM8Rxp/DcBfCfSI3bGwwoMMxxy34D2e58WAqXmmdnh0WYlAQ8jeOB3A1ed5KUSm"
      crossorigin="anonymous"
    />
    <!-- uicons icon -->
    <link
    ...
    />
    <!-- custom -->
    <link rel="stylesheet" href="assets/css/styles-form-indikator-spmi.css" />
  </head>
  <body>
    <!-- sidebar -->
        ...
        <div>
          ...
          <div class="sidebar__content-nav">
            <ul class="sidebar-nav__list">
              ...
              <li>
                <a
                  id="sidebar-main-icon"
                  class="nav__list__link-dropdown"
                  data-bs-toggle="collapse"
                  href="#data-induk-collapse"
                  aria-expanded="false"
                  aria-controls="data-induk-collapse"
                >
                ...
                <!-- dropdown -->
                <div
                  class="collapse collapse__dropside"
                  id="data-induk-collapse"
                >
                  <ul class="sidebar-nav__list-collapse">
                    <li>
                      <a
                        href="data-induk.html"
                        class="nav__list__link-collapse ellipsis__text"
                        >S1 Informatika</a
                      >
                    </li>
                    <li>
              ...
              <li>
                <a
                  class="nav__list__link-dropdown active"
                  data-bs-toggle="collapse"
                  href="#spmi-collapse"
                  aria-expanded="false"
    ...
    <div class="main__content" id="main-content">
      ...
      <div class="container-fluid container__fluid pb-0">
        <div class="header__main-nav">
          ...
          <div class="header__main-nav-profile">
            <div class="nav-profile__photo">
              <img
                src="assets/img/adi-wibowo-img.png"
                alt="profile-picture"
                id="photo-dropdown"
              />
            </div>
        ...
        <div>
          <form>
            <div class="row mb-3">
              <label for="indikator" class="col-sm-2 col-form-label"
                >Indikator</label
              >
              <div class="col-sm-10">
                <textarea
                  ...
                  disabled
                >
Tersedia pedoman rumusan kualifikasi lulusan berupa Capaian Pembelajaran Lulusan (CPL) mencakup aspek sikap, pengetahuan, dan keterampilan</textarea
                >
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <textarea
                  ...
                  disabled
                >
Tersusunnya pernyataan CPL sesuai dengan SKL berdasarkan jenis dan jenjang pendidikan pada KKNI serta SN-DIKTI</textarea
                >
              </div>
            </div>
            <div class="row mb-3">
              <label for="data-prodi" class="col-sm-2 col-form-label"
                >Data Prodi</label
              >
              <div class="col-sm-10">
                <input type="text" class="form-control" id="data-prodi" />
              </div>
            </div>
            <div class="row mb-3">
              <label for="hasil" class="col-sm-2 col-form-label">Hasil</label>
              <div class="col-sm-10">
                <select class="form-select" id="hasil">
