      ...
      <div>
        <form>
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea class="form-control form__control" id="indikator" cols="30" rows="3" disabled required>
Tersedia pedoman rumusan kualifikasi lulusan berupa Capaian Pembelajaran Lulusan (CPL) mencakup aspek sikap, pengetahuan, dan keterampilan</textarea>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea class="form-control form__control" id="target" cols="30" rows="3" disabled required>
Tersusunnya pernyataan CPL sesuai dengan SKL berdasarkan jenis dan jenjang pendidikan pada KKNI serta SN-DIKTI</textarea>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control form__control" id="data-prodi" required />
            </div>
          </div>
          <div class="row mb-3">
            <label for="hasil" class="col-sm-2 col-form-label form__label">Hasil</label>
            <div class="col-sm-10">
              <select class="form-select form__select" id="hasil">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea class="form-control form__control" id="keterangan" cols="30" rows="3" disabled>
Tersusunnya pernyataan CPL sesuai dengan SKL berdasarkan jenis dan jenjang pendidikan pada KKNI serta SN-DIKTI</textarea>
            </div>
          </div>
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea class="form-control form__control" id="catatan" cols="30" rows="3" disabled>
Tersusunnya pernyataan CPL sesuai dengan SKL berdasarkan jenis dan jenjang pendidikan pada KKNI serta SN-DIKTI</textarea>
            </div>
          </div>
