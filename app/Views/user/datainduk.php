...
<html lang="en">
  <head>
    ...
    <title>Data Induk - S1 Informatika | SIPMPP UNDIP</title>
    ...
    <link rel="stylesheet" href="assets/css/styles-data-induk.css" />
  </head>
  <body>
    <!-- sidebar -->
    ...
    <div class="main__content" id="main-content">
      ...
      <div class="container-fluid container__fluid pb-0">
        ...
        <div class="filter__datainduk">
          <div
            class="filter__datainduk-panel nav nav-pills"
            id="pills-tab"
            role="tablist"
          >
            <button
              class="btn filter__btn me-0 me-md-4 shadow-none active nav-link active"
              id="pills-home-tab"
              data-bs-toggle="pill"
            ...
            <button
              class="btn filter__btn shadow-none nav-link ellipsis__text"
