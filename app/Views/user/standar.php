...
<html lang="en">
  <head>
    ...
    <title>Nilai SPMI - S1 Informatika | SIPMPP UNDIP</title>
    ...
    />
    <!-- custom -->
    <link rel="stylesheet" href="assets/css/styles-spmi.css" />
  </head>
  <body>
    <!-- sidebar -->
    ...
    <div class="main__content" id="main-content">
      <!-- header main -->
      <div class="header__main-color header__mini header__spmi"></div>
      <div class="container-fluid container__fluid pb-0">
        ...
        <div class="filter__table">
          <div class="nav nav-pills" id="pills-tab" role="tablist">
            <button
              class="btn filter__btn me-0 me-md-3 shadow-none active nav-link active"
              id="pills-home-tab"
              data-bs-toggle="pill"
            ...
            <button
              class="btn filter__btn shadow-none nav-link"
          ...
          >
            <div class="sipmpp__table">
              <div class="table-responsive">
                <table
                  class="table table__spmi__content sipmpp__table-content table-hover"
                  id="spmi-penelitian"
                >
